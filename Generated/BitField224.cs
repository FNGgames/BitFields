...
{
    /// <summary>
    /// Unmanaged 224 bit struct used to represent a collection of flags.
    /// All standard bitwise operators are implemented ( &amp; | ^ ~ &lt;&lt; &gt;&gt; )
    /// </summary>
    public unsafe struct BitField224 : IEquatable<BitField224>
    {
        ...
        /// </summary>
        public static BitField224 none => new BitField224();

        /// <summary>
        /// A new bitfield with all bits set to 1
        /// </summary>
        public static BitField224 all => ~new BitField224();
        ...
        /// Mask of bits to set
        /// </param>
        public void SetBits(in BitField224 mask) => Or(in mask);
        ...
        /// </param>
        public void UnsetBits(in BitField224 mask) => AndNot(in mask);
        ...
        /// </param>
        public void FlipBits(in BitField224 mask) => XOr(in mask);
        ...
        /// Query mask
        /// </param>
        public bool HasAllOf(in BitField224 mask) => (this & mask) == mask;
        ...
        /// Query mask
        /// </param>
        public bool HasAnyOf(in BitField224 mask) => !(this & mask).IsEmpty();
        ...
        /// Query mask
        /// </param>
        public bool HasNoneOf(in BitField224 mask) => (this & mask).IsEmpty();
        ...
        /// Query mask
        /// </param>
        public void And(in BitField224 mask)
        {
            for (var i = 0; i < wordCount; i++)
        ...
        /// Query mask
        /// </param>
        public void AndNot(in BitField224 mask)
        {
            for (var i = 0; i < wordCount; i++)
                words[i] &= ~mask.words[i];
        }
        ...
        /// Query mask
        /// </param>
        public void Nand(in BitField224 mask)
        {
            for (var i = 0; i < wordCount; i++)
        ...
        /// Query mask
        /// </param>
        public void Or(in BitField224 mask)
        {
            for (var i = 0; i < wordCount; i++)
                words[i] |= mask.words[i];
        }
        ...
        /// Query mask
        /// </param>
        public void OrNot(in BitField224 mask)
        {
            for (var i = 0; i < wordCount; i++)
                words[i] |= ~mask.words[i];
        }
        ...
        /// Query mask
        /// </param>
        public void Nor(in BitField224 mask)
        {
            for (var i = 0; i < wordCount; i++)
                words[i] = ~(words[i] | mask.words[i]);
        }
        ...
        /// Query mask
        /// </param>
        public void XOr(in BitField224 mask)
        {
            for (var i = 0; i < wordCount; i++)
                words[i] ^= mask.words[i];
        }
        ...
        /// Query mask
        /// </param>
        public void XOrNot(in BitField224 mask)
        {
            for (var i = 0; i < wordCount; i++)
                words[i] ^= ~mask.words[i];
        }
        ...
        /// Query mask
        /// </param>
        public void NotXOr(in BitField224 mask)
        {
            for (var i = 0; i < wordCount; i++)
                words[i] = ~(words[i] ^ mask.words[i]);
        }
        ...
        /// <returns>a &amp; b</returns>
        public static BitField224 operator &(BitField224 a, BitField224 b)
        {
            var c = a;
            c.And(in b);
            return c;
        ...
        public static BitField224 operator &(BitField224 a, int index)
        {
            var c = a;
        ...
        /// <param name="a">First operand</param>
        /// <returns>~a</returns>
        public static BitField224 operator ~(BitField224 a)
        {
            var c = a;
            c.Not();
            return c;
        ...
        /// <returns> a &lt;&lt; d</returns>
        public static BitField224 operator <<(BitField224 a, int d)
        {
            var c = a;
            c.Shift(-d);
            return c;
        ...
        /// <param name="b">Second operand</param>
        /// <returns>a == b</returns>
        public static bool operator ==(BitField224 a, BitField224 b) => a.Equals(b);
        ...
        {
            const string typeName = nameof(BitField224);
        ...
        /// array's bits
        /// </returns>
        public override bool Equals(object obj) => obj is BitField224 other && Equals(other);
        ...
        /// </returns>
        public bool Equals(BitField224 other)
        {
            for (var i = 0; i < wordCount; i++)
