...
{
    /// <summary>
    /// Unmanaged 96 bit struct used to represent a collection of flags.
    /// All standard bitwise operators are implemented ( &amp; | ^ ~ &lt;&lt; &gt;&gt; )
    /// </summary>
    public unsafe struct BitField96 : IEquatable<BitField96>
    {
        ...
        /// </summary>
        public static BitField96 none => new BitField96();

        /// <summary>
        /// A new bitfield with all bits set to 1
        /// </summary>
        public static BitField96 all => ~new BitField96();
        ...
        /// Mask of bits to set
        /// </param>
        public void SetBits(in BitField96 mask) => Or(in mask);
        ...
        /// </param>
        public void UnsetBits(in BitField96 mask) => AndNot(in mask);
        ...
        /// </param>
        public void FlipBits(in BitField96 mask) => XOr(in mask);
        ...
        /// Query mask
        /// </param>
        public bool HasAllOf(in BitField96 mask) => (this & mask) == mask;
        ...
        /// Query mask
        /// </param>
        public bool HasAnyOf(in BitField96 mask) => !(this & mask).IsEmpty();
        ...
        /// Query mask
        /// </param>
        public bool HasNoneOf(in BitField96 mask) => (this & mask).IsEmpty();
        ...
        /// Query mask
        /// </param>
        public void And(in BitField96 mask)
        {
            for (var i = 0; i < wordCount; i++)
        ...
        /// Query mask
        /// </param>
        public void AndNot(in BitField96 mask)
        {
            for (var i = 0; i < wordCount; i++)
                words[i] &= ~mask.words[i];
        }
        ...
        /// Query mask
        /// </param>
        public void Nand(in BitField96 mask)
        {
            for (var i = 0; i < wordCount; i++)
        ...
        /// Query mask
        /// </param>
        public void Or(in BitField96 mask)
        {
            for (var i = 0; i < wordCount; i++)
                words[i] |= mask.words[i];
        }
        ...
        /// Query mask
        /// </param>
        public void OrNot(in BitField96 mask)
        {
            for (var i = 0; i < wordCount; i++)
                words[i] |= ~mask.words[i];
        }
        ...
        /// Query mask
        /// </param>
        public void Nor(in BitField96 mask)
        {
            for (var i = 0; i < wordCount; i++)
                words[i] = ~(words[i] | mask.words[i]);
        }
        ...
        /// Query mask
        /// </param>
        public void XOr(in BitField96 mask)
        {
            for (var i = 0; i < wordCount; i++)
                words[i] ^= mask.words[i];
        }
        ...
        /// Query mask
        /// </param>
        public void XOrNot(in BitField96 mask)
        {
            for (var i = 0; i < wordCount; i++)
                words[i] ^= ~mask.words[i];
        }
        ...
        /// Query mask
        /// </param>
        public void NotXOr(in BitField96 mask)
        {
            for (var i = 0; i < wordCount; i++)
                words[i] = ~(words[i] ^ mask.words[i]);
        }
        ...
        /// <returns>a &amp; b</returns>
        public static BitField96 operator &(BitField96 a, BitField96 b)
        {
            var c = a;
            c.And(in b);
            return c;
        ...
        public static BitField96 operator &(BitField96 a, int index)
        {
            var c = a;
        ...
        /// <param name="a">First operand</param>
        /// <returns>~a</returns>
        public static BitField96 operator ~(BitField96 a)
        {
            var c = a;
            c.Not();
            return c;
        ...
        /// <returns> a &lt;&lt; d</returns>
        public static BitField96 operator <<(BitField96 a, int d)
        {
            var c = a;
            c.Shift(-d);
            return c;
        ...
        /// <param name="b">Second operand</param>
        /// <returns>a == b</returns>
        public static bool operator ==(BitField96 a, BitField96 b) => a.Equals(b);
        ...
        {
            const string typeName = nameof(BitField96);
        ...
        /// array's bits
        /// </returns>
        public override bool Equals(object obj) => obj is BitField96 other && Equals(other);
        ...
        /// </returns>
        public bool Equals(BitField96 other)
        {
            for (var i = 0; i < wordCount; i++)
