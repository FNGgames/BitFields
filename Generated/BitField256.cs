...
{
    /// <summary>
    /// Unmanaged 256 bit struct used to represent a collection of flags.
    /// All standard bitwise operators are implemented ( &amp; | ^ ~ &lt;&lt; &gt;&gt; )
    /// </summary>
    public unsafe struct BitField256 : IEquatable<BitField256>
    {
        ...
        /// </summary>
        public static BitField256 none => new BitField256();

        /// <summary>
        /// A new bitfield with all bits set to 1
        /// </summary>
        public static BitField256 all => ~new BitField256();
        ...
        /// Mask of bits to set
        /// </param>
        public void SetBits(in BitField256 mask) => Or(in mask);
        ...
        /// </param>
        public void UnsetBits(in BitField256 mask) => AndNot(in mask);
        ...
        /// </param>
        public void FlipBits(in BitField256 mask) => XOr(in mask);
        ...
        /// Query mask
        /// </param>
        public bool HasAllOf(in BitField256 mask) => (this & mask) == mask;
        ...
        /// Query mask
        /// </param>
        public bool HasAnyOf(in BitField256 mask) => !(this & mask).IsEmpty();
        ...
        /// Query mask
        /// </param>
        public bool HasNoneOf(in BitField256 mask) => (this & mask).IsEmpty();
        ...
        /// Query mask
        /// </param>
        public void And(in BitField256 mask)
        {
            for (var i = 0; i < wordCount; i++)
        ...
        /// Query mask
        /// </param>
        public void AndNot(in BitField256 mask)
        {
            for (var i = 0; i < wordCount; i++)
                words[i] &= ~mask.words[i];
        }
        ...
        /// Query mask
        /// </param>
        public void Nand(in BitField256 mask)
        {
            for (var i = 0; i < wordCount; i++)
        ...
        /// Query mask
        /// </param>
        public void Or(in BitField256 mask)
        {
            for (var i = 0; i < wordCount; i++)
                words[i] |= mask.words[i];
        }
        ...
        /// Query mask
        /// </param>
        public void OrNot(in BitField256 mask)
        {
            for (var i = 0; i < wordCount; i++)
                words[i] |= ~mask.words[i];
        }
        ...
        /// Query mask
        /// </param>
        public void Nor(in BitField256 mask)
        {
            for (var i = 0; i < wordCount; i++)
                words[i] = ~(words[i] | mask.words[i]);
        }
        ...
        /// Query mask
        /// </param>
        public void XOr(in BitField256 mask)
        {
            for (var i = 0; i < wordCount; i++)
                words[i] ^= mask.words[i];
        }
        ...
        /// Query mask
        /// </param>
        public void XOrNot(in BitField256 mask)
        {
            for (var i = 0; i < wordCount; i++)
                words[i] ^= ~mask.words[i];
        }
        ...
        /// Query mask
        /// </param>
        public void NotXOr(in BitField256 mask)
        {
            for (var i = 0; i < wordCount; i++)
                words[i] = ~(words[i] ^ mask.words[i]);
        }
        ...
        /// <returns>a &amp; b</returns>
        public static BitField256 operator &(BitField256 a, BitField256 b)
        {
            var c = a;
            c.And(in b);
            return c;
        ...
        public static BitField256 operator &(BitField256 a, int index)
        {
            var c = a;
        ...
        /// <param name="a">First operand</param>
        /// <returns>~a</returns>
        public static BitField256 operator ~(BitField256 a)
        {
            var c = a;
            c.Not();
            return c;
        ...
        /// <returns> a &lt;&lt; d</returns>
        public static BitField256 operator <<(BitField256 a, int d)
        {
            var c = a;
            c.Shift(-d);
            return c;
        ...
        /// <param name="b">Second operand</param>
        /// <returns>a == b</returns>
        public static bool operator ==(BitField256 a, BitField256 b) => a.Equals(b);
        ...
        {
            const string typeName = nameof(BitField256);
        ...
        /// array's bits
        /// </returns>
        public override bool Equals(object obj) => obj is BitField256 other && Equals(other);
