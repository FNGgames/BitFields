...
{
    /// <summary>
    /// Unmanaged 160 bit struct used to represent a collection of flags.
    /// All standard bitwise operators are implemented ( &amp; | ^ ~ &lt;&lt; &gt;&gt; )
    /// </summary>
    public unsafe struct BitField160 : IEquatable<BitField160>
    {
        ...
        /// </summary>
        public static BitField160 none => new BitField160();

        /// <summary>
        /// A new bitfield with all bits set to 1
        /// </summary>
        public static BitField160 all => ~new BitField160();
        ...
        /// Mask of bits to set
        /// </param>
        public void SetBits(in BitField160 mask) => Or(in mask);
        ...
        /// </param>
        public void UnsetBits(in BitField160 mask) => AndNot(in mask);
        ...
        /// </param>
        public void FlipBits(in BitField160 mask) => XOr(in mask);
        ...
        /// Query mask
        /// </param>
        public bool HasAllOf(in BitField160 mask) => (this & mask) == mask;
        ...
        /// Query mask
        /// </param>
        public bool HasAnyOf(in BitField160 mask) => !(this & mask).IsEmpty();
        ...
        /// Query mask
        /// </param>
        public bool HasNoneOf(in BitField160 mask) => (this & mask).IsEmpty();
        ...
        /// Query mask
        /// </param>
        public void And(in BitField160 mask)
        {
            for (var i = 0; i < wordCount; i++)
        ...
        /// Query mask
        /// </param>
        public void AndNot(in BitField160 mask)
        {
            for (var i = 0; i < wordCount; i++)
                words[i] &= ~mask.words[i];
        }
        ...
        /// Query mask
        /// </param>
        public void Nand(in BitField160 mask)
        {
            for (var i = 0; i < wordCount; i++)
        ...
        /// Query mask
        /// </param>
        public void Or(in BitField160 mask)
        {
            for (var i = 0; i < wordCount; i++)
                words[i] |= mask.words[i];
        }
        ...
        /// Query mask
        /// </param>
        public void OrNot(in BitField160 mask)
        {
            for (var i = 0; i < wordCount; i++)
                words[i] |= ~mask.words[i];
        }
        ...
        /// Query mask
        /// </param>
        public void Nor(in BitField160 mask)
        {
            for (var i = 0; i < wordCount; i++)
                words[i] = ~(words[i] | mask.words[i]);
        }
        ...
        /// Query mask
        /// </param>
        public void XOr(in BitField160 mask)
        {
            for (var i = 0; i < wordCount; i++)
                words[i] ^= mask.words[i];
        }
        ...
        /// Query mask
        /// </param>
        public void XOrNot(in BitField160 mask)
        {
            for (var i = 0; i < wordCount; i++)
                words[i] ^= ~mask.words[i];
        }
        ...
        /// Query mask
        /// </param>
        public void NotXOr(in BitField160 mask)
        {
            for (var i = 0; i < wordCount; i++)
                words[i] = ~(words[i] ^ mask.words[i]);
        }
        ...
        /// <returns>a &amp; b</returns>
        public static BitField160 operator &(BitField160 a, BitField160 b)
        {
            var c = a;
            c.And(in b);
            return c;
        ...
        public static BitField160 operator &(BitField160 a, int index)
        {
            var c = a;
        ...
        /// <param name="a">First operand</param>
        /// <returns>~a</returns>
        public static BitField160 operator ~(BitField160 a)
        {
            var c = a;
            c.Not();
            return c;
        ...
        /// <returns> a &lt;&lt; d</returns>
        public static BitField160 operator <<(BitField160 a, int d)
        {
            var c = a;
            c.Shift(-d);
            return c;
        ...
        /// <param name="b">Second operand</param>
        /// <returns>a == b</returns>
        public static bool operator ==(BitField160 a, BitField160 b) => a.Equals(b);
        ...
        {
            const string typeName = nameof(BitField160);
        ...
        /// array's bits
        /// </returns>
        public override bool Equals(object obj) => obj is BitField160 other && Equals(other);
        ...
        /// </returns>
        public bool Equals(BitField160 other)
        {
            for (var i = 0; i < wordCount; i++)
